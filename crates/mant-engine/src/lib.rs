...
pub use output::{
    ...
    render_explanation_markdown, render_explanation_text, render_markdown,
    ...
    render_scope_explanation_text, render_search_json, render_search_markdown, render_search_text,
