...
in release mode and runs the independent M3--M6 parser lanes plus strict M9
upstream renderer comparison concurrently. The native canonical parser
snapshot remains a separate regression check, not an independent compatibility
oracle.
