//! Archive-backed native parser gates and their exact diagnostic expectations.
...
use super::corpus::{
    CorpusArchiveError, CorpusCase, CorpusCasePayload, stable_1_14_6_case, stable_1_14_6_inventory,
};
