...
install -m 0644 crates/mant/src/delivery/pager/vendor/LICENSE-MIT "$package/LICENSES/MINUS-MIT"
install -m 0644 crates/mant/src/delivery/pager/vendor/LICENSE-APACHE "$package/LICENSES/MINUS-APACHE"
