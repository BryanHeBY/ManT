...
# F10 opens Manual; Right twice selects View; Down three times selects Expand All.
xdotool windowfocus --sync "$window"
xdotool key --clearmodifiers --delay 100 F10 Right Right Down Down Down Return
sleep 0.5
