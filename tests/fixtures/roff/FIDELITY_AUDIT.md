...
| `freebsd-15.1-amd64` | Official FreeBSD 15.1-RELEASE amd64 `base.txz` | 357 stable, syntax-prioritized, and source-directed pages from 11,183 paths / 4,085 distinct sources | 346 latest clean scans; 11 reviewed candidates; 5 real lowering defects fixed and 9 source-checked false positives |
